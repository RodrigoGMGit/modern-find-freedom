    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className={`relative z-10 text-center text-white px-4 sm:px-6 max-w-6xl mx-auto py-20 transition-opacity duration-300 ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <div className="flex justify-center mb-6 sm:mb-8">
          <div className="p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-full shadow-cta border border-white/20">
      ...
      <Button
        ...
        size="icon"
        onClick={prevSlide}
        className="absolute left-2 sm:left-4 md:left-8 top-1/2 -translate-y-1/2 z-20 text-white hover:bg-white/20 backdrop-blur-sm rounded-full w-10 h-10 sm:w-12 sm:h-12 border border-white/30 transition-smooth"
      ...
      <Button
        ...
        size="icon"
        onClick={nextSlide}
        className="absolute right-2 sm:right-4 md:right-8 top-1/2 -translate-y-1/2 z-20 text-white hover:bg-white/20 backdrop-blur-sm rounded-full w-10 h-10 sm:w-12 sm:h-12 border border-white/30 transition-smooth"
