  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <main className="relative pt-24 sm:pt-28 pb-16 sm:pb-20">
        ...
        <section className="relative h-64 sm:h-80 md:h-96 mb-12 sm:mb-16 lg:mb-20 overflow-hidden rounded-2xl mx-4 sm:mx-6 lg:mx-12 shadow-card">
          <img
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-brand-ink-900/90 via-brand-teal-500/80 to-brand-ink-800/90 flex items-center justify-center p-4">
            <div className="text-center">
              ...
              <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4 leading-heading-1">
                Diplomado en Prevención
              </h2>
              <p className="font-body text-sm sm:text-base md:text-lg text-brand-mint-200/90 mb-6 sm:mb-8 max-w-2xl mx-auto">
